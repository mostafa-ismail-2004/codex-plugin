...
The `suggest-compact.sh` script runs on PreToolUse for edit/write-like tools and:
...
Codex Plugin bundles this through `hooks/hooks.json`:
    ...
    "PreToolUse": [
      {
        ...
        "hooks": [
          {
            "type": "command",
            "command": "bash /hooks/suggest-compact.sh"
          }
        ]
      },
      {
