...
- **Zero runtime risk** — Pure Markdown skill. Nothing runs on invocation beyond Codex loading this skill's Markdown instructions.

## Installation

This skill ships with Codex Plugin. No separate installation is needed when the plugin is installed.

### Full plugin install

If you are working from the Codex Plugin repository checkout, verify the skill is present with:

```bash
test -f skills/blueprint/SKILL.md
```

To update later, review the repository diff before updating:
