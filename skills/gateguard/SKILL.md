...
A PreToolUse hook pattern that forces Codex to investigate before editing. Instead of self-evaluation ("are you sure?"), it demands concrete facts. The act of investigation creates awareness that self-evaluation never did.
...
- Any workflow where an agent tends to guess instead of investigating
