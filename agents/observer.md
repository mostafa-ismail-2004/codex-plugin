...
- Project: `~/.codex/codex-plugin/continuous-learning/projects/<project-hash>/observations.jsonl`
- Global fallback: `~/.codex/codex-plugin/continuous-learning/observations.jsonl`
...
- Project: `~/.codex/codex-plugin/continuous-learning/projects/<project-hash>/instincts/personal/`
- Global: `~/.codex/codex-plugin/continuous-learning/instincts/personal/` (for universal patterns)
