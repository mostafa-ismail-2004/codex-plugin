...
OBSERVER_INTERVAL_MINUTES="${CODEX_PLUGIN_OBSERVER_RUN_INTERVAL:-5}"
MIN_OBSERVATIONS="${CODEX_PLUGIN_OBSERVER_MIN_OBSERVATIONS:-20}"
OBSERVER_ENABLED="${CODEX_PLUGIN_OBSERVER_ENABLED:-false}"
