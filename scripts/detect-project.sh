...
#   _CLV2_PROJECT_DIR    - Project-scoped storage directory under continuous-learning
#
# Also sets unprefixed convenience aliases:
#   PROJECT_ID, PROJECT_NAME, PROJECT_ROOT, PROJECT_DIR
#
# Detection priority:
#   1. CODEX_PLUGIN_PROJECT_DIR env var (if set)
...
_CLV2_HOMUNCULUS_DIR="${CODEX_PLUGIN_HOME:-${HOME}/.codex/codex-plugin}/continuous-learning"
...
_clv2_detect_project() {
  ...
  # Normalize Windows backslashes so basename works when CODEX_PLUGIN_PROJECT_DIR
