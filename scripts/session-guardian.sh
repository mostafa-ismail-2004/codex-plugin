...
# Called by observer-loop.sh before spawning any Codex observer session.
#
# Config (env vars, all optional):
#   OBSERVER_INTERVAL_SECONDS    default: 300   (per-project cooldown)
#   OBSERVER_LAST_RUN_LOG        default: ~/.codex/codex-plugin/observer-last-run.log
...
LOG_PATH="${OBSERVER_LAST_RUN_LOG:-${CODEX_PLUGIN_HOME:-$HOME/.codex/codex-plugin}/observer-last-run.log}"
