...
from scripts.skill_comply.grader import grade
from scripts.skill_comply.report import generate_report
from scripts.skill_comply.runner import run_scenario
from scripts.skill_comply.scenario_generator import generate_scenarios
from scripts.skill_comply.spec_generator import generate_spec
...
def main() -> None:
    ...
    parser.add_argument(
        "--model",
        default="inherit",
        help="Model for scenario execution (default: inherit)",
    )
    parser.add_argument(
        "--gen-model",
        default="gpt-5.5",
